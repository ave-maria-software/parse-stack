  ...
  module Properties
    ...
    module ClassMethods
      ...
      def property(key, data_type = :string, **opts)
        ...
        # elamonica 2022 (upstream issue #73, never answered): Parse Numbers are
        # doubles — coercing :number/:int to :integer TRUNCATES floats on the
        # write path. :float is lossless for both.
